...
const Jacob = new Employee('Jacob', 'Orbach', 'jacoborbach96@gmail.com', 24)
//console.log(Jacob);
//Jacob.makeWidget();
...
const Henry = new Manager('Henry', 'Beathoven', 'henryb@gmail.com', 33)
//console.log(Henry)
// Henry.hire('Jonathan')
// Henry.hire('Noam')
// Henry.fire('Jonathan')
...
const lion = new ProgressiveManager('Lion', 'Lastname', 'lionL22@gmail.com', 40)
//console.log(lion)
//lion.hire('Jonathan');
//lion.fire('Jonathan')
//console.log(lion)
